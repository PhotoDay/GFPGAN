...
if __name__ == "__main__":
    ...
    parser.add_argument("-mp", "--retouch-model-path", type=str, default="/data/pd/saved_models_danial/gfpgan/20240819_glare/net_g_200000.pth", help="Path to the retouch model.")
